I was just thinking of a metaphor were a Jell-O heart represents my heart/feelings; where I give someone my heart, and it gets smashed, thrown out, rejected, stabbed, unwanted, etc... I was thinking of how I would actually demonstrate this (hence the Jell-O), and giving that heart to someone for them to try. 

- I though of making the first heart get rejected; so how do I do that?
	- maybe I can put something in there to make it taste bad
		- but then it might make someone throw up, and I don't want that to happen
	- then I though of putting dark green, gross-looking slime in the middle of it, cutting it in half for them to try that piece, making them not want to try it.
This made me realize that for someone to reject my heart so often, there needs to be something wrong with it--my actual heart (not biological, but also not the Jell-O heart; my heart/feelings).

1. The first heart is given as a half, with some gross, green goo in the center, oozing out.
	- it gets rejected
2. The second heart gets ripped into pieces, and each is squeezed and crushed with a hand, squelching, and oozing between the fingers.
	- it's extra personal.
3. The third gets filled with air, or green goo, and explodes.
...
5. the fifth heart is presented, and accepted. But then it's inflated with goo (It doesn't explode) then is punctured or lacerated several times; goo oozing out, and getting everywhere.
